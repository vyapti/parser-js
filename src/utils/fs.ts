 ...
 * this empty wrapper has been added to allow sinon to stub properly, while
 * still allowing the fs module functions to used when building/running the
 * project.
 *
 * More research is needed to track down the underlying issue that prevents
 * sinon from stubbing the fs module properly, but this workaround can be used
 * in the meantime.
 */
export default fs;
